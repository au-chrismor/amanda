...
*glib_init = *Amanda::Utilc::glib_init;
*setenv_init = *Amanda::Utilc::setenv_init;
...
*quote_string_always = *Amanda::Utilc::quote_string_always;
...
*split_quoted_strings_for_amstatus = *Amanda::Utilc::split_quoted_strings_for_amstatus;
...
*match_labelstr_template = *Amanda::Utilc::match_labelstr_template;
*match_labelstr = *Amanda::Utilc::match_labelstr;
*make_crc_table = *Amanda::Utilc::make_crc_table;
*crc32_init = *Amanda::Utilc::crc32_init;
*crc32_add = *Amanda::Utilc::crc32_add;
*crc32_finish = *Amanda::Utilc::crc32_finish;
...
*set_pcomponent = *Amanda::Utilc::set_pcomponent;
*get_pcomponent = *Amanda::Utilc::get_pcomponent;
*set_pmodule = *Amanda::Utilc::set_pmodule;
*get_pmodule = *Amanda::Utilc::get_pmodule;
*push_component_module = *Amanda::Utilc::push_component_module;
*pop_component_module = *Amanda::Utilc::pop_component_module;
*safe_cd = *Amanda::Utilc::safe_cd;
*check_running_as = *Amanda::Utilc::check_running_as;
*amxml_format_tag = *Amanda::Utilc::amxml_format_tag;
*get_fsusage = *Amanda::Utilc::get_fsusage;
*get_time_from_timestamp = *Amanda::Utilc::get_time_from_timestamp;
*get_platform = *Amanda::Utilc::get_platform;
*get_distro = *Amanda::Utilc::get_distro;
...
sub pcontext_t_to_value {
    my ($stringvalue) = @_;

    if (defined $_pcontext_t_VALUES{$stringvalue}) {
	return $_pcontext_t_VALUES{$stringvalue}
    }
...
push @EXPORT_OK, qw(quote_string quote_string_always unquote_string skip_quoted_string
		sanitise_filename split_quoted_strings split_quoted_strings_friendly split_quoted_strings_for_amstatus);
push @{$EXPORT_TAGS{"quoting"}}, qw(quote_string quote_string_always unquote_string skip_quoted_string
		sanitise_filename split_quoted_strings split_quoted_strings_friendly split_quoted_strings_for_amstatus);
...
push @EXPORT_OK, qw(match_host match_disk match_datestamp match_level match_labelstr match_labelstr_template match_labelstr_expr);
