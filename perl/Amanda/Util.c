...
#define SWIGTYPE_p_autolabel_t swig_types[1]
#define SWIGTYPE_p_char swig_types[2]
#define SWIGTYPE_p_crc_t swig_types[3]
#define SWIGTYPE_p_double swig_types[4]
#define SWIGTYPE_p_file_lock swig_types[5]
#define SWIGTYPE_p_float swig_types[6]
#define SWIGTYPE_p_fs_usage swig_types[7]
#define SWIGTYPE_p_in_port_t swig_types[8]
#define SWIGTYPE_p_int swig_types[9]
#define SWIGTYPE_p_labelstr_s swig_types[10]
...
void
setenv_init(void) {
    /* The follwoing line break on sles 11 and perl-5.10.0 */
...
SWIGINTERN void delete_file_lock(file_lock *self){
	    file_lock_free(self);
	}
...
XS(_wrap_setenv_init) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: setenv_init();");
    }
    setenv_init();
    ST(argvi) = sv_newmortal();
    XSRETURN(argvi);
...
XS(_wrap_quote_string_always) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: quote_string_always(char *);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "quote_string_always" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    result = (char *)quote_string_always(arg1);
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
    free((char*)result);
    XSRETURN(argvi);
...
XS(_wrap_expand_braced_alternates) {
  {
    ...
    result = (GPtrArray *)expand_braced_alternates(arg1);
    {
      if (result) {
        ...
        for (i = 0, pdata = result->pdata; i < result->len; i++) {
          char *str = *pdata++;
          ST(argvi) = sv_2mortal(newSVpv(str, 0));
          g_free(str);
          argvi++;
        }
...
XS(_wrap_split_quoted_strings_for_amstatus) {
  {
    gchar *arg1 = (gchar *) 0 ;
    int res1 ;
    char *buf1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: split_quoted_strings_for_amstatus(string);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "split_quoted_strings_for_amstatus" "', argument " "1"" of type '" "gchar const *""'");
    }
    arg1 = (gchar *)(buf1);
    result = (gchar **)split_quoted_strings_for_amstatus((char const *)arg1);
    {
      gchar **iter;
...
XS(_wrap_stream_server) {
  {
    ...
    }
    {
      gchar *err = NULL;
      if (sizeof(size_t) == 1) {
        arg3 = amglue_SvU8(ST(1), &err);
      } else if (sizeof(size_t) == 2) {
        arg3 = amglue_SvU16(ST(1), &err);
      } else if (sizeof(size_t) == 4) {
        arg3 = amglue_SvU32(ST(1), &err);
    ...
    }
    {
      gchar *err = NULL;
      if (sizeof(size_t) == 1) {
        arg4 = amglue_SvU8(ST(2), &err);
      } else if (sizeof(size_t) == 2) {
        arg4 = amglue_SvU16(ST(2), &err);
      } else if (sizeof(size_t) == 4) {
        arg4 = amglue_SvU32(ST(2), &err);
      } else if (sizeof(size_t) == 8) {
        arg4 = amglue_SvU64(ST(2), &err);
      } else {
        croak("Unexpected size_t >64 bits?"); /* should be optimized out unless sizeof(size_t) > 8 */
      }
      if (err) croak("%s", err);
...
XS(_wrap_stream_accept) {
  {
    ...
    }
    {
      gchar *err = NULL;
      if (sizeof(size_t) == 1) {
        arg4 = amglue_SvU8(ST(3), &err);
      } else if (sizeof(size_t) == 2) {
        arg4 = amglue_SvU16(ST(3), &err);
      } else if (sizeof(size_t) == 4) {
        arg4 = amglue_SvU32(ST(3), &err);
      } else if (sizeof(size_t) == 8) {
        arg4 = amglue_SvU64(ST(3), &err);
      } else {
        croak("Unexpected size_t >64 bits?"); /* should be optimized out unless sizeof(size_t) > 8 */
      }
      if (err) croak("%s", err);
...
XS(_wrap_check_security) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: check_security(fd,userstr,service);");
    }
    {
      IO *io = NULL;
      PerlIO *pio = NULL;
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "check_security" "', argument " "3"" of type '" "char *""'");
    }
    arg3 = (char *)(buf3);
    result = (char *)check_security_fd(arg1,arg2,arg3);
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
...
XS(_wrap_match_labelstr_template) {
  {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    char *arg3 = (char *) 0 ;
    ...
    if ((items < 5) || (items > 5)) {
      SWIG_croak("Usage: match_labelstr_template(l_template,label,barcode,meta,storage);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "match_labelstr_template" "', argument " "1"" of type '" "char const *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "match_labelstr_template" "', argument " "2"" of type '" "char const *""'");
    }
    arg2 = (char *)(buf2);
    res3 = SWIG_AsCharPtrAndSize(ST(2), &buf3, NULL, &alloc3);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "match_labelstr_template" "', argument " "3"" of type '" "char const *""'");
    }
    arg3 = (char *)(buf3);
    res4 = SWIG_AsCharPtrAndSize(ST(3), &buf4, NULL, &alloc4);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "match_labelstr_template" "', argument " "4"" of type '" "char const *""'");
    }
    arg4 = (char *)(buf4);
    res5 = SWIG_AsCharPtrAndSize(ST(4), &buf5, NULL, &alloc5);
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "match_labelstr_template" "', argument " "5"" of type '" "char const *""'");
    }
    arg5 = (char *)(buf5);
    result = (gboolean)match_labelstr_template((char const *)arg1,(char const *)arg2,(char const *)arg3,(char const *)arg4,(char const *)arg5);
    {
      if (result)
      ST(argvi) = &PL_sv_yes;
      else
...
XS(_wrap_match_labelstr) {
  {
    labelstr_s *arg1 = (labelstr_s *) 0 ;
    autolabel_t *arg2 = (autolabel_t *) 0 ;
    char *arg3 = (char *) 0 ;
    char *arg4 = (char *) 0 ;
    char *arg5 = (char *) 0 ;
    char *arg6 = (char *) 0 ;
    ...
    if ((items < 6) || (items > 6)) {
      SWIG_croak("Usage: match_labelstr(labelstr,autolabel,label,barcode,meta,storage);");
    }
    {
      HV *hv;
      SV *sv;
      labelstr_s *labelstr = g_new0(labelstr_s, 1);
      
      if (!SvROK(ST(0)))
      croak("Argument 1 is not a reference.");
      if (SvTYPE(SvRV(ST(0))) != SVt_PVHV)
      croak("Argument 1 is not an hash.");
    ...
    }
    {
      ...
      croak("Argument 2 is not an hash.");
    ...
    res3 = SWIG_AsCharPtrAndSize(ST(2), &buf3, NULL, &alloc3);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "match_labelstr" "', argument " "3"" of type '" "char const *""'");
    }
    arg3 = (char *)(buf3);
    res4 = SWIG_AsCharPtrAndSize(ST(3), &buf4, NULL, &alloc4);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "match_labelstr" "', argument " "4"" of type '" "char const *""'");
    }
    arg4 = (char *)(buf4);
    res5 = SWIG_AsCharPtrAndSize(ST(4), &buf5, NULL, &alloc5);
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "match_labelstr" "', argument " "5"" of type '" "char const *""'");
    }
    arg5 = (char *)(buf5);
    res6 = SWIG_AsCharPtrAndSize(ST(5), &buf6, NULL, &alloc6);
    if (!SWIG_IsOK(res6)) {
      SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "match_labelstr" "', argument " "6"" of type '" "char const *""'");
    }
    arg6 = (char *)(buf6);
    result = (gboolean)match_labelstr((labelstr_s const *)arg1,(autolabel_t const *)arg2,(char const *)arg3,(char const *)arg4,(char const *)arg5,(char const *)arg6);
    {
      if (result)
      ST(argvi) = &PL_sv_yes;
      else
    ...
    {
      g_free(arg1->template);
      g_free(arg1);
    }
    {
      g_free(arg2->template);
      g_free(arg2);
    }
    if (alloc3 == SWIG_NEWOBJ) free((char*)buf3);
    if (alloc4 == SWIG_NEWOBJ) free((char*)buf4);
...
XS(_wrap_make_crc_table) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: make_crc_table();");
    }
    make_crc_table();
    ST(argvi) = sv_newmortal();
    XSRETURN(argvi);
...
XS(_wrap_crc32_init) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: crc32_init(crc);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_crc_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "crc32_init" "', argument " "1"" of type '" "crc_t *""'"); 
    }
    arg1 = (crc_t *)(argp1);
    crc32_init(arg1);
    ST(argvi) = sv_newmortal();
...
XS(_wrap_crc32_add) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: crc32_add(buf,len,crc);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_uint8_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "crc32_add" "', argument " "1"" of type '" "uint8_t *""'"); 
    }
    arg1 = (uint8_t *)(argp1);
    {
      gchar *err = NULL;
    ...
    res3 = SWIG_ConvertPtr(ST(2), &argp3,SWIGTYPE_p_crc_t, 0 |  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "crc32_add" "', argument " "3"" of type '" "crc_t *""'"); 
    }
    arg3 = (crc_t *)(argp3);
    crc32_add(arg1,arg2,arg3);
    ST(argvi) = sv_newmortal();
...
XS(_wrap_crc32_finish) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: crc32_finish(crc);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_crc_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "crc32_finish" "', argument " "1"" of type '" "crc_t *""'"); 
    }
    arg1 = (crc_t *)(argp1);
    result = crc32_finish(arg1);
    {
      SV *for_stack;
      SP += argvi; PUTBACK;
      for_stack = sv_2mortal(amglue_newSVu64(result));
...
XS(_wrap_set_pcomponent) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: set_pcomponent(component);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_pcomponent" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    set_pcomponent(arg1);
    ST(argvi) = sv_newmortal();
...
XS(_wrap_get_pcomponent) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: get_pcomponent();");
    }
    result = (char *)get_pcomponent();
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
...
XS(_wrap_set_pmodule) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: set_pmodule(module);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_pmodule" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    set_pmodule(arg1);
    ST(argvi) = sv_newmortal();
...
XS(_wrap_get_pmodule) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: get_pmodule();");
    }
    result = (char *)get_pmodule();
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
...
XS(_wrap_push_component_module) {
  {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    int res1 ;
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: push_component_module(component,module);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "push_component_module" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "push_component_module" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    push_component_module(arg1,arg2);
    ST(argvi) = sv_newmortal();
    if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
    if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
    XSRETURN(argvi);
...
XS(_wrap_pop_component_module) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: pop_component_module();");
    }
...
XS(_wrap_amxml_format_tag) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: amxml_format_tag(tag,value);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "amxml_format_tag" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "amxml_format_tag" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    result = (char *)amxml_format_tag(arg1,arg2);
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
    if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
    free((char*)result);
...
XS(_wrap_get_fsusage) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: get_fsusage(dir);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_fsusage" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    result = get_fsusage(arg1);
    {
      SV *for_stack;
      SP += argvi; PUTBACK;
      for_stack = sv_2mortal(amglue_newSVi64(result));
...
XS(_wrap_get_time_from_timestamp) {
  {
    char *arg1 = (char *) 0 ;
    int res1 ;
    char *buf1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: get_time_from_timestamp(timestamp);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_time_from_timestamp" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    result = get_time_from_timestamp(arg1);
    {
      SV *for_stack;
      SP += argvi; PUTBACK;
      for_stack = sv_2mortal(amglue_newSVi64(result));
...
XS(_wrap_get_platform) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: get_platform();");
    }
    result = (char *)get_platform();
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    free((char*)result);
    XSRETURN(argvi);
  fail:
...
XS(_wrap_get_distro) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: get_distro();");
    }
    result = (char *)get_distro();
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    free((char*)result);
    XSRETURN(argvi);
  fail:
...
static swig_type_info _swigt__p_autolabel_t = {"_p_autolabel_t", "autolabel_t *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_file_lock = {"_p_file_lock", "file_lock *", 0, 0, (void*)"Amanda::Util::file_lock", 0};
...
static swig_type_info _swigt__p_labelstr_s = {"_p_labelstr_s", "labelstr_s *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_autolabel_t[] = {  {&_swigt__p_autolabel_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_labelstr_s[] = {  {&_swigt__p_labelstr_s, 0, 0, 0},{0, 0, 0, 0}};
...
{"Amanda::Utilc::glib_init", _wrap_glib_init},
{"Amanda::Utilc::setenv_init", _wrap_setenv_init},
...
{"Amanda::Utilc::quote_string_always", _wrap_quote_string_always},
...
{"Amanda::Utilc::split_quoted_strings_for_amstatus", _wrap_split_quoted_strings_for_amstatus},
...
{"Amanda::Utilc::match_labelstr_template", _wrap_match_labelstr_template},
{"Amanda::Utilc::match_labelstr", _wrap_match_labelstr},
{"Amanda::Utilc::make_crc_table", _wrap_make_crc_table},
{"Amanda::Utilc::crc32_init", _wrap_crc32_init},
{"Amanda::Utilc::crc32_add", _wrap_crc32_add},
{"Amanda::Utilc::crc32_finish", _wrap_crc32_finish},
...
{"Amanda::Utilc::set_pcomponent", _wrap_set_pcomponent},
{"Amanda::Utilc::get_pcomponent", _wrap_get_pcomponent},
{"Amanda::Utilc::set_pmodule", _wrap_set_pmodule},
{"Amanda::Utilc::get_pmodule", _wrap_get_pmodule},
{"Amanda::Utilc::push_component_module", _wrap_push_component_module},
{"Amanda::Utilc::pop_component_module", _wrap_pop_component_module},
{"Amanda::Utilc::safe_cd", _wrap_safe_cd},
{"Amanda::Utilc::check_running_as", _wrap_check_running_as},
{"Amanda::Utilc::amxml_format_tag", _wrap_amxml_format_tag},
{"Amanda::Utilc::get_fsusage", _wrap_get_fsusage},
{"Amanda::Utilc::get_time_from_timestamp", _wrap_get_time_from_timestamp},
{"Amanda::Utilc::get_platform", _wrap_get_platform},
{"Amanda::Utilc::get_distro", _wrap_get_distro},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
