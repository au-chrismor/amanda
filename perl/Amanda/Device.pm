...
*reset = *Amanda::Devicec::Device_reset;
...
*clear_bytes_read = *Amanda::Devicec::Device_clear_bytes_read;
...
*init_seek_file = *Amanda::Devicec::Device_init_seek_file;
...
*check_writable = *Amanda::Devicec::Device_check_writable;
*have_set_reuse = *Amanda::Devicec::Device_have_set_reuse;
*set_reuse = *Amanda::Devicec::Device_set_reuse;
*set_no_reuse = *Amanda::Devicec::Device_set_no_reuse;
*sync_catalog = *Amanda::Devicec::Device_sync_catalog;
*create = *Amanda::Devicec::Device_create;
*allow_take_scribe_from = *Amanda::Devicec::Device_allow_take_scribe_from;
...
sub ConcurrencyParadigm_to_value {
    my ($stringvalue) = @_;

    if (defined $_ConcurrencyParadigm_VALUES{$stringvalue}) {
	return $_ConcurrencyParadigm_VALUES{$stringvalue}
    }
...
#Convert an string to a enum value
sub StreamingRequirement_to_value {
    my ($stringvalue) = @_;

    if (defined $_StreamingRequirement_VALUES{$stringvalue}) {
	return $_StreamingRequirement_VALUES{$stringvalue}
    }
...
#Convert an string to a enum value
sub MediaAccessMode_to_value {
    my ($stringvalue) = @_;

    if (defined $_MediaAccessMode_VALUES{$stringvalue}) {
	return $_MediaAccessMode_VALUES{$stringvalue}
    }
