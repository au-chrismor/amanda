...
*get_logtype_str = *Amanda::Logfilec::get_logtype_str;
*get_program_str = *Amanda::Logfilec::get_program_str;
...
*make_logname = *Amanda::Logfilec::make_logname;
*get_logname = *Amanda::Logfilec::get_logname;
*set_logname = *Amanda::Logfilec::set_logname;
*log_rename = *Amanda::Logfilec::log_rename;
*log_start_multiline = *Amanda::Logfilec::log_start_multiline;
*log_end_multiline = *Amanda::Logfilec::log_end_multiline;
...
*getheaderfname = *Amanda::Logfilec::getheaderfname;
*getstatefname = *Amanda::Logfilec::getstatefname;
*getindexfname = *Amanda::Logfilec::getindexfname;
*getindex_unsorted_fname = *Amanda::Logfilec::getindex_unsorted_fname;
*getindex_unsorted_gz_fname = *Amanda::Logfilec::getindex_unsorted_gz_fname;
*getindex_sorted_fname = *Amanda::Logfilec::getindex_sorted_fname;
*getindex_sorted_gz_fname = *Amanda::Logfilec::getindex_sorted_gz_fname;
...
*swig_storage_get = *Amanda::Logfilec::find_result_t_storage_get;
*swig_storage_set = *Amanda::Logfilec::find_result_t_storage_set;
*swig_storage_id_get = *Amanda::Logfilec::find_result_t_storage_id_get;
*swig_storage_id_set = *Amanda::Logfilec::find_result_t_storage_id_set;
*swig_pool_get = *Amanda::Logfilec::find_result_t_pool_get;
*swig_pool_set = *Amanda::Logfilec::find_result_t_pool_set;
...
*swig_native_crc_get = *Amanda::Logfilec::find_result_t_native_crc_get;
*swig_native_crc_set = *Amanda::Logfilec::find_result_t_native_crc_set;
*swig_client_crc_get = *Amanda::Logfilec::find_result_t_client_crc_get;
*swig_client_crc_set = *Amanda::Logfilec::find_result_t_client_crc_set;
*swig_server_crc_get = *Amanda::Logfilec::find_result_t_server_crc_get;
*swig_server_crc_set = *Amanda::Logfilec::find_result_t_server_crc_set;
sub new {
    my $pkg = shift;
...
*L_RETRY = *Amanda::Logfilec::L_RETRY;
...
*P_AMREPORT = *Amanda::Logfilec::P_AMREPORT;
...
*P_AMCLEANUP = *Amanda::Logfilec::P_AMCLEANUP;
*P_AMBACKUPD = *Amanda::Logfilec::P_AMBACKUPD;
*P_AMTRMIDX = *Amanda::Logfilec::P_AMTRMIDX;
*P_AMTRMLOG = *Amanda::Logfilec::P_AMTRMLOG;
...
sub logtype_t_to_value {
    my ($stringvalue) = @_;

    if (defined $_logtype_t_VALUES{$stringvalue}) {
	return $_logtype_t_VALUES{$stringvalue}
    }
...
push @EXPORT_OK, qw($L_RETRY);
push @{$EXPORT_TAGS{"logtype_t"}}, qw($L_RETRY);

$_logtype_t_VALUES{"L_RETRY"} = $L_RETRY;
...
#Convert an string to a enum value
sub program_t_to_value {
    my ($stringvalue) = @_;

    if (defined $_program_t_VALUES{$stringvalue}) {
	return $_program_t_VALUES{$stringvalue}
    }
...
push @EXPORT_OK, qw($P_AMREPORT);
push @{$EXPORT_TAGS{"program_t"}}, qw($P_AMREPORT);

$_program_t_VALUES{"P_AMREPORT"} = $P_AMREPORT;
...
push @EXPORT_OK, qw($P_AMCLEANUP);
push @{$EXPORT_TAGS{"program_t"}}, qw($P_AMCLEANUP);

$_program_t_VALUES{"P_AMCLEANUP"} = $P_AMCLEANUP;

push @EXPORT_OK, qw($P_AMBACKUPD);
push @{$EXPORT_TAGS{"program_t"}}, qw($P_AMBACKUPD);

$_program_t_VALUES{"P_AMBACKUPD"} = $P_AMBACKUPD;

push @EXPORT_OK, qw($P_AMTRMIDX);
push @{$EXPORT_TAGS{"program_t"}}, qw($P_AMTRMIDX);

$_program_t_VALUES{"P_AMTRMIDX"} = $P_AMTRMIDX;

push @EXPORT_OK, qw($P_AMTRMLOG);
push @{$EXPORT_TAGS{"program_t"}}, qw($P_AMTRMLOG);

$_program_t_VALUES{"P_AMTRMLOG"} = $P_AMTRMLOG;
