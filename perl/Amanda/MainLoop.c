...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Amanda__MainLoop_var::
class _wrap_Amanda__MainLoop_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_run_until_empty_c) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: run_until_empty_c();");
    }
    run_until_empty_c();
    ST(argvi) = sv_newmortal();
    XSRETURN(argvi);
...
{"Amanda::MainLoopc::run_until_empty_c", _wrap_run_until_empty_c},
